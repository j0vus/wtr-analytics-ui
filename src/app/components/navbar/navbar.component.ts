...
export class NavbarComponent implements OnInit {
  ...
  selectedDateRange() {
    let dateConverter = new utilityMethods();
    const startDate = dateConverter.convertDateFormat(
      this.startDateInput.nativeElement.value
    );
    const endDate = dateConverter.convertDateFormat(
    ...
    if (pages.includes(this.getTitle())) {
      ...
      this.shareData.updateSharedData(
        this.getTitle() + ":" + startDate + ":" + endDate + ":" + search
      );
    } else {
      this.shareData.updateSharedData(
        this.getTitle() + ":" + startDate + ":" + endDate
      );
    }
  }
